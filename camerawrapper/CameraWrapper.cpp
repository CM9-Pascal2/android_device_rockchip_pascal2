...
camera_module_t HAL_MODULE_INFO_SYM = {
    common: {
         ...
         version_major: CAMERA_MODULE_API_VERSION_2_0,
         version_minor: 0,
         id: CAMERA_HARDWARE_MODULE_ID,
         name: "BQPascal 2 Camera Wrapper",
         author: "joaquimorg <android@joaquim.org>",
...
static int check_vendor_module()
{
    ...
    if (rv)
        ALOGE("failed to open vendor camera module : %s");
    return rv;
}
